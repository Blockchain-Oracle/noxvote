...
- UI remains outside this contract plan. The separate 2026-08-01 frontend authorization accepts
  Direction C — ORBIT and routes implementation to a dedicated frontend agent.
